...
const Productcard:React.FC<ProductCardProps>=({
  ...
  return(
    <div className="bg-white p-4 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out">
        ...
        <p className="text-lg text-amber-500 mb-4">{price}</p>

        <button onClick={()=>onAddToCart({id,name,price,image})}
            className="bg-red-600 text-white px-4 rounded-lg text-lg shadow-md hover:bg-yellow-500 transition duration-300 ease-in-out">
                Add to Cart
